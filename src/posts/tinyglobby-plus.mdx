---
title: "Introducing tinyglobby plus"
...
// ---cut-after---
// @filename: tinyglobby-plus.d.ts
import { GlobOptions as Options } from 'tinyglobby';
declare module 'tinyglobby-plus';
declare const glob: (patterns: string | string[], options?: GlobOptions) => Promise<string[]>;
